...
<head>
	...
	<title>Ur-Fine - Login Page</title>
...
<body class="simple-page">
	<div id="back-to-home">
		<a href="../user_page.php" class="btn btn-outline btn-default"><i class="fa fa-home animated zoomIn"></i></a>
	</div>
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
			
				<span style="color: white"><i class="fa fa-heartbeat"></i></span>
				<span style="color: white">Ur-Fine</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign In With Your Ur-Fine Account</h4>
